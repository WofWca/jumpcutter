...
const ElementPlaybackControllerStretchingSpecificDefaults = {
  ...
  marginBefore: 0,
  marginAfter: 0.03 + 0.002 * (100 - simpleSliderDefaultVal),
} as const;

export const defaultSettings: Readonly<Settings> = {
  volumeThreshold:
    ElementPlaybackControllerStretchingSpecificDefaults.volumeThreshold,
  previousVolumeThreshold:
    ElementPlaybackControllerStretchingSpecificDefaults.volumeThreshold,
  silenceSpeedSpecificationMethod: "relativeToSoundedSpeed",
  // If you decide to change these values,
  // remember to also update them in `popup/App.svelte`.
  silenceSpeedRaw: 1.5 + simpleSliderDefaultVal * 0.02,
  previousSilenceSpeedRaw: 1.5 + simpleSliderDefaultVal * 0.02,
  ...
  marginBefore:
    ElementPlaybackControllerStretchingSpecificDefaults.marginBefore,
  previousMarginBefore:
    ElementPlaybackControllerStretchingSpecificDefaults.marginBefore,
  marginAfter: ElementPlaybackControllerStretchingSpecificDefaults.marginAfter,
  previousMarginAfter:
    ElementPlaybackControllerStretchingSpecificDefaults.marginAfter,
  ...
  popupMarginBeforeStep: 0.01,

  popupMarginAfterMin: 0,
  popupMarginAfterMax: 0.5,
  popupMarginAfterStep: 0.01,
