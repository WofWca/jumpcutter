...
export type ModifierPropName = keyof Pick<
  KeyboardEvent,
...
export type HotkeyActionArguments<T extends HotkeyAction> =
  T extends NoArgumentAction ? never : number;
...
export type NonSettingsActions = Array<
  DeepReadonly<HotkeyBinding<NonSettingsAction>>
>;
