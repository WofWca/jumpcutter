...
(async function () {
  ...
  browserOrChrome.storage.onChanged.addListener(function (
    ...
    if (
      maybeEnabledChange?.newValue === true &&
      maybeEnabledChange.oldValue === false
    ) {
      importAndInit();
    }
  });
